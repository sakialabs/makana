...
import { signUp, signInWithGoogle, signInWithApple, signInWithFacebook, signInWithGitHub, validateEmail, validatePassword } from '../lib/auth';
...
export function SignUpScreen({ navigation }: SignUpScreenProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (error) {
      // Display error with sign-in link for "already registered" errors
    ...
    if (data) {
      if (requiresConfirmation) {
        ...
        // No confirmation required, go directly to dashboard
        Alert.alert('Account Created', 'Welcome. You can now start practicing.');
